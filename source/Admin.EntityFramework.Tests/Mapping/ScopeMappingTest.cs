...
namespace Admin.EntityFramework.Tests.Mapping
{
    public class ScopeMappingTest
    {
        ...
        {
            var efScope = new IdentityServer3.EntityFramework.Entities.Scope();
        ...
        public void Maps_entity_framework_scope_to_storage_scope()
        {
            var efScope = new IdentityServer3.EntityFramework.Entities.Scope()
            {
                ...
                IncludeAllClaimsForUser = true,
                Required = true,
                ScopeClaims  = new List<IdentityServer3.EntityFramework.Entities.ScopeClaim>()
                {
                    new IdentityServer3.EntityFramework.Entities.ScopeClaim()
                    {
                        AlwaysIncludeInIdToken = true,
                        Description = "Description",
                        Id = 2,
